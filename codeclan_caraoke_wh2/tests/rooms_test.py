...
class TestRooms(unittest.TestCase):
    def setUp(self):
        ...
        self.guest_2 = Guests("Claire", 10)
        self.guest_3 = Guests("Keith", 10)
        self.guest_4 = Guests("Jimbob", 11)
        self.guest_5 = Guests("Divina", 12)
        self.guest_6 = Guests("Lindsay", 4)
        self.guest_7 = Guests("Hilda", 5)
        self.guest_8 = Guests("Bluey's Dad", 8)
        self.guest_9 = Guests("Id Monster", 100)
        self.guest_10 = Guests("Omega", 20)
        self.guest_11 = Guests("Rassilon", 11)
        self.guest_12 = Guests("Tecteun", 4)
